-- =============================================================================
-- CineGacha: Star Cap and RPC Star Return
-- =============================================================================
-- Run this migration in the Supabase Dashboard SQL Editor:
--   Supabase Dashboard -> SQL Editor -> New Query -> Paste & Run
--
-- This migration:
--   1. Caps existing stars at 4 (display 5)
--   2. Adds CHECK constraint to enforce stars <= 4
--   3. Updates open_pack RPC to cap star increment and return star count
-- =============================================================================

-- ---------------------------------------------------------------------------
-- 1. Cap existing stars that may exceed 4
-- ---------------------------------------------------------------------------
UPDATE public.user_cards SET stars = 4 WHERE stars > 4;

-- ---------------------------------------------------------------------------
-- 2. Add CHECK constraint: stars range 0 (display 1) to 4 (display 5)
-- ---------------------------------------------------------------------------
ALTER TABLE public.user_cards
  ADD CONSTRAINT user_cards_stars_max CHECK (stars <= 4);

-- ---------------------------------------------------------------------------
-- 3. Updated open_pack RPC: LEAST() cap on star increment, stars in result
-- ---------------------------------------------------------------------------
